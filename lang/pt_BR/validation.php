...
return [
    ...
    | classe validator. Algumas dessas regras têm várias versões, como as
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Esta senha é muito comum na internet e fácil de adivinhar. Por favor, tente uma combinação mais exclusiva.',
    ],
    ...
    */
    ...
    'custom' => [
        'email' => [
            'exists' => 'Este endereço de e-mail não foi encontrado em nossos registros.',
        ],
        'token' => [
            'required' => 'O token de redefinição é inválido ou expirou.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar nosso marcador de posição
    | de atributo por algo mais amigável ao leitor, como "E-Mail Address" em vez
